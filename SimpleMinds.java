...
SimpleMinds() {
 ...
 ImageIcon i1;
    i1 = new ImageIcon(ClassLoader.getSystemResource("simple\\minds\\Icon\\login.jpeg"));
...
l2.setFont(new Font("Viner Hsand ITC",Font.BOLD,40));
l2.setForeground(new Color(30,144,254));
l2.setBounds(750,60,300,45);
add(l2);

JLabel l3=new JLabel("Enter your name:");
l3.setFont(new Font("Mongolia Baiti",Font.BOLD,18));

...
q[1][0]="What is the return type ofthe hashCode() method in the Object class?";
q[1][1]="int";
q[1][2]="object";
q[1][3]="long";
q[1][4]="void";

q[2][0]="Which package containe the Random class?";
q[2][1]="java.until package";
q[2][2]="java.lang package";
q[2][3]="java.awt package";
q[2][4]="java.io package";

q[3][0]="An interface with on fields oe method is known as?";
q[3][1]="Runnable Interface";
q[3][2]="Abstract Interface";
q[3][3]="Maeker Interface";
q[3][4]="CharSequence Interface";

q[4][0]="In which memory a SString is stored, when we create a string using new operator?";
q[4][1]="Stack";
q[4][2]="String memory";
q[4][3]="Random storage space";
q[4][4]="Heap memory";

q[5][0]="Which of following is a marker interface?";
q[5][1]="Runnable interface";
q[5][2]="Remote interface";
q[5][3]="Readable interface";
q[5][4]="Result interface";

q[6][0]="Which keyword is used for accessing the featurs of a package?";
q[6][1]="import";
q[6][2]="package";
q[6][3]="oxtends";
q[6][4]="oxpoet";
...
q[9][2]="The appl;ett makes the Java codde secure and portable";
q[9][3]="Use of oxception handling";
q[9][4]="Dynamic binding between object";
...
if(timer >0) {
	...
	g.drawString("Times Up!!",1100,530);
}
